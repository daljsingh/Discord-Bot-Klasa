exports.run = async (client, msg, [user]) => {
  try {
    await msg.mentions.members.first().removeRole(msg.guild.roles.find('name', 'Time-Out'))
    msg.reply('', { embed: {
      color: 3447003,
      author: {
    ...
    client.channels.get('341020497309597696').send(`There was an error trying to unmute: ${e} in ${msg.channel} on ${msg.guild} by ${msg.author}`)
  }
}
