  ...
  if (mes === 'vg') {
    ...
    if (randomChance === 1) {
      const embed = new client.methods.Embed()
        ...
        .setColor(0x00AE86)
        .setDescription(`Please go to [Discord](https://discord.gg/VHVY7rb), to claim your ${config.lottery.amount} ICE by @HR-Staff with your IGN! They will help add your name to the lottery-list. No this isn't a scam you really did win ICE for using the EZLBot.`)
